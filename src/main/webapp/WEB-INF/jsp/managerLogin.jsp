...
<span class="border border-secondary">
	<table class="table">
		<tr>
			<td><label class="label label-primary" for="email">Email Address:</label></td>
			<td><input id="email" name="email" class="form-control" placeholder="Enter Email" required="required"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="password" id="password" class="form-control" placeholder="Enter Password" required="required"/></td>
		</tr>
		<tr>
