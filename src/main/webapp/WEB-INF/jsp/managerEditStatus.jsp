...
<span class="border border-secondary">
	<table class="table">
		<tr>
			<td><label class="label label-primary" for="requestid">Enter Request Id:</label></td>
			<td><input id="requestid" name="requestid" class="form-control" placeholder="Enter Request Id" required="required"/></td>
		</tr>
		<tr>
			<td><label class="label label-primary" for="status">Change Status To:</label></td>
...
<option value="Received">Received</option>
		...
		<tr>
			<td><button class="btn btn-success" type="submit" id="submit" name="submit">Change Status</button></td>
